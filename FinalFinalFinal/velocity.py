...
def get_velocity(img1, img2, f, ratio, t):
    '''
    img1 and img2 are images after warping
    f: focal length
...
# img1 = cv2.imread('/Users/zhaosonglin/Documents/GitHub/EIE4512_pano_proj/Eric_code/frame_50.png')
# img2 = cv2.imread('/Users/zhaosonglin/Documents/GitHub/EIE4512_pano_proj/Eric_code/frame_52.png')
# img1 = mycyl.cylindricalWarping(img1, 1544)
# img2 = mycyl.cylindricalWarping(img2, 1544)
# a = get_velocity(img1, img2, 1544, 0.6, 1/15)
# print(a)
# print(a / 30)