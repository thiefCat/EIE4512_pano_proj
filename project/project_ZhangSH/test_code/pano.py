...
# img1 = cv2.imread('data\source003\panorama02_01.jpg') # query img
# img2 = cv2.imread('data\source003\panorama02_02.jpg') # train img

# img1 = cv2.imread('data\source001\source001_01.jpg') # query img
# img2 = cv2.imread('data\source001\source001_02.jpg') # train img
...
img3, good_indexes, keypoints_1, keypoints_2 = sift_matching(img1, img2, threshold=0.2, max_length=30)
...
# print('pts_loc1', pts_loc1)
# print('pts_loc2', pts_loc2)
# print(len(pts_loc1))
# print(len(pts_loc2))
...
# img1_mk = mark_pts(img1, pts_loc1)
# img2_mk = mark_pts(img2, pts_loc2)
# cv2.imshow('img1', img1_mk)
# cv2.imshow('img2', img2_mk)
...
'''
def homo_transform(poz: tuple, paras):
    # carry out homography transformation on one point

    # get 8 coefficients
    a,b,c,d,e,f,g,h = paras.flatten()
    i = 1
...
warpshape2 = (img2.shape[0]*3, img2.shape[1]*3)
img2_warp = cv2.warpPerspective(img2, H, dsize = warpshape2)

cv2.imshow('warpped1', img1)
cv2.imshow('warpped2', img2_warp)
cv2.waitKey(0)
